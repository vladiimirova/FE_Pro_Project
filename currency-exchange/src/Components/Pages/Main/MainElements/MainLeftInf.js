...
function MainLeftInf() {
  return (
    <div>
      ...
      <Link
        to="/"
        className="bg-[#2C36F2] text-white font-roboto font-medium font-normal text-[16px] hover:bg-[#1E90FF] rounded-[4px]  w-[234px] h-[53px] inline-flex items-center justify-center text-center mt-[29px]"
      >
        Конвертувати валюту
      </Link>
    </div>
