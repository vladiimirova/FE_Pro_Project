...
describe('CabinetInf component', () => {
  ...
  test('Отображает кнопки для управления аккаунтом', () => {
    render(<CabinetInf />);
  ...
  test('Отображает историю операций', () => {
    render(<CabinetInf />);
  ...
  test('Проверка кнопок с правильными стилями', () => {
